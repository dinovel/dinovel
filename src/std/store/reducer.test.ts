...
Deno.test('Should match reducer type', () => {
...
Deno.test('Should match reducer payload', () => {
  interface State {
    foo: string;
  }
...
Deno.test('Should set reducer name', () => {
...
Deno.test('Should reset reducer state', () => {
  const reducer = getReducer();
...
Deno.test('Should throw if try to change state', () => {
  const reducer = getReducer();
...
Deno.test('Should apply action changes', () => {
  const reducer = getReducer();
...
Deno.test('Should notify on state change', () => {
  const reducer = getReducer();
...
Deno.test('Should not notify on actions that don\'t change state', () => {
  const reducer = getReducer();
  let callCount = 0;
